...
{ 
  ...
  fill(color(255, 255, 255));
  briefing2 = createDiv("- Words starting with the same letter have the same background color");
  briefing2.id('main_text');
  briefing2.position(10, briefing2_pos_y_offset);


  let briefing3_pos_y_offset = briefing2_pos_y_offset + briefing2.size().height + 10;
  fill(color(255, 255, 255));
  briefing3 = createDiv("- Above the first word of each letter, the starting letter is highlighted");
